import React, {PropsWithRef, useEffect, useRef, useState, useLayoutEffect} from 'react';
// import Wrapper from "./Wrapper";
import {Product} from "../interfaces/product";
import {Link} from "react-router-dom";

const Checkout = (props: PropsWithRef<any>) => {
   ...
   useEffect(() => {
    ...
    (
        ...
        const shipping_response = await fetch(`http://localhost:8000/orders/shippings/${payment_data[0].payment_order}`);
    ...
    const del = async (order_id: number) => {
        if(window.confirm('Are you sure you want to delete this product?')) {
            ...
            setOrders(orders.filter((p: Product) => p.order_id != order_id));
        }
            ...
            <form className="needs-validation" noValidate>
                <div className="row g-3">
                    <div className="col-sm-6">
                        ...
                        <input readOnly type="text" className="form-control" id="firstName" />
                ...
                <hr className="my-4"/>
                    ...
                    <div className="form-check">
                        <input type="checkbox" className="form-check-input" id="same-address"/>
                            <label className="form-check-label" htmlFor="same-address">Shipping address is the same as
